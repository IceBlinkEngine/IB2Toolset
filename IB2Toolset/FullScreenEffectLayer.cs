...
namespace IB2Toolset
{
    public class FullScreenEffectLayer
    {
        ...
        [CategoryAttribute("01 - Main"), DescriptionAttribute("use this layer yes/no")]
        public bool useFullScreenEffectLayer
        {
            get { return _useFullScreenEffectLayer; }
            set { _useFullScreenEffectLayer = value; }
        }
        [CategoryAttribute("01 - Main"), DescriptionAttribute("activate this layer on/off")]
        ...
        [CategoryAttribute("01 - Main"), DescriptionAttribute("layer name")]
